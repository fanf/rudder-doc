...
There is two exceptions to that rule:

- for unique (non multi-instance) technique, the directive with the highest priority is selected and other are discarded (and they will be tagged as such in node detail compliance),
